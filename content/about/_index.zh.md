---
title: "关于我 🧑‍💻"
description: "了解更多关于Sucran的信息"
showTableOfContents: true
---

我是 理查德·苏，我从2019年开始从事技术工作，在这期间我参与了各种类型的项目，如：分布式作业调度系统、云原生流式数据湖系统、大数据平台（专注于作业编排和诊断）、RAG系统。

这个GitHub账户自2019年以来一直处于休眠状态，因为我之前的代码都在企业内网中，而且我没有精力为开源社区做贡献。我现在正在积极拥抱开源社区。

我也在**寻找新的工作机会**。 由于我希望花时间陪伴家人，我倾向于远程或混合办公的职位，工作地点需要在中国大陆或香港。如果需要现场办公，职位必须位于中国福建省厦门/福州。

**您可以通过richardsucran(at)gmail.com联系我进行招聘。我通常每两天检查一次新邮件。请发送正式的职位发布信息；我会查看并联系您**

## 技术栈 🔧

**徽章的顺序表示了我的熟练程度，从左到右，是非常熟练到基本使用的程度**
...
当我不敲代码的时候，我是：
- 炉石传说爱好者 (会剪辑发布一些游戏视频到 Bilibili / Youtube)
- 正念布道师 (我长期参加一个正念中文社群： 暂停实验室)
- 阅读爱好者, 我读过的一些好书：
    - 《命运》/《草民》/《皮囊》/《我人生最开始的好朋友》 —— 蔡崇达
    - 《成事》/《正道》 —— 冯唐
    - 《人类简史》/《未来简史》/《智人之上》 —— Yuval Noah Harari
    - 《明朝那些事儿》 —— 当年明月
    - 《被讨厌的勇气》/《幸福的勇气》 —— 岸见一郎
    - 《拆掉思维里的墙》/《不上班咖啡馆》 —— 古典
    - 《父亲巴菲特教我的事》 —— Peter Buffett
    - 《原则》 —— Ray Dalio
    - ……
- 长期减肥失败不气馁的运动人群
...
我一向很喜欢加入加入技术社群，同编程老炮和技术发烧友们一起聊聊科技进展，你可以从以下方式找到我：
