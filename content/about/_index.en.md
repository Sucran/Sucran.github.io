---
title: "About Me 🧑‍💻"
description: "Get to know more about Sucran"
---

I'm Richard Su, **I've been working with technology since 2019**, and during this time I worked with the most diverse types of projects like: **Distributed Job Scheduling Systems, CloudNative Streaming Lakehouse Systems, Big Data Platforms (with a focus on job orchestration and diagnostics)，RAG System**.
...
<style>
/* Fix badge images to display inline */
.prose figure img[src*="img.shields.io"],
...
/* Additional fix for badge spacing */
.prose p:has(img[src*="img.shields.io"]) {
  margin: 0 !important;
...
- Hearthstone enthusiast (I edit and publish game videos to Bilibili / Youtube)
- Mindfulness advocate (I have been participating in a Chinese mindfulness community: Pause Lab)
- Reading enthusiast, some good books I've read:
    - Destiny / Grassroots / Skin / My First Best Friend in Life — Cai Chongda
    - Getting Things Done / The Right Path — Feng Tang
    - Sapiens: A Brief History of Humankind / Homo Deus: A Brief History of Tomorrow / 21 Lessons for the 21st Century — Yuval Noah Harari
    - The Ming Dynasty Stories — Dang Nian Ming Yue
    - The Courage to Be Disliked / The Courage to Be Happy — Ichiro Kishimi
    - Breaking Down the Walls in Your Mind / The No-Work Café — Gu Dian
    - Life Is What You Make It — Peter Buffett
    - Principles — Ray Dalio
    - ……
- A fitness enthusiast who never gives up despite long-term weight loss failures

## Let's Connect

I'm always excited to connect with fellow developers and tech enthusiasts. Feel free to reach out!

- **GitHub**: [sucran](https://github.com/sucran)
- **Email**: richardsucran(at)gmail.com
